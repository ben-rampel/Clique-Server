...
(
    ...
    GroupId     BIGINT UNSIGNED,
    PRIMARY KEY (Id),
    CONSTRAINT GROUP_PERSON FOREIGN KEY (GroupId) REFERENCES `PersonGroup` (Id) ON DELETE SET NULL
);
...
(
    ...
    CONSTRAINT GROUP_MESSAGE FOREIGN KEY (GroupId) REFERENCES `PersonGroup` (Id) ON DELETE CASCADE
)